...
var normalizeHeaderName = __webpack_require__(648);
...
function getDefaultAdapter() {
  ...
  if (typeof process !== 'undefined' && Object.prototype.toString.call(process) === '[object process]') {
    ...
    adapter = __webpack_require__(615);
  } else if (typeof XMLHttpRequest !== 'undefined') {
    // For browsers use XHR adapter
    adapter = __webpack_require__(973);
  }
  return adapter;
}
...
exports.humanize = __webpack_require__(792);
...
var isCancel = __webpack_require__(945);
...
axios.isCancel = __webpack_require__(945);
...
const axios = __webpack_require__(724)
...
var utils = __webpack_require__(768);
var buildURL = __webpack_require__(433);
...
var httpFollow = __webpack_require__(791).http;
var httpsFollow = __webpack_require__(791).https;
...
try {
  var supportsColor = __webpack_require__(408);
...
var bind = __webpack_require__(869);
var isBuffer = __webpack_require__(851);
...
var debug = __webpack_require__(414)("follow-redirects");
...
var settle = __webpack_require__(325);
var buildURL = __webpack_require__(433);
var parseHeaders = __webpack_require__(876);
...
module.exports = function xhrAdapter(config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (utils.isStandardBrowserEnv()) {
      var cookies = __webpack_require__(831);
